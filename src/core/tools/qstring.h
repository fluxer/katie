...
{
public:
    inline explicit QLatin1String(const char *s) : chars(s), charssize(qstrlen(chars)) {}
    ...
    inline const char *data() const { return chars; }
    inline int size() const { return charssize; }
