...
class Q_CORE_EXPORT QIPv6Address
{
public:
...
class Q_CORE_EXPORT QHostAddress
{
public:
    enum SpecialAddress {
        Null,
...
Q_CORE_EXPORT QDebug operator<<(QDebug, const QHostAddress &);
#endif


Q_CORE_EXPORT uint qHash(const QHostAddress &key);

#ifndef QT_NO_DATASTREAM
Q_CORE_EXPORT QDataStream &operator<<(QDataStream &, const QHostAddress &);
Q_CORE_EXPORT QDataStream &operator>>(QDataStream &, QHostAddress &);
#endif
