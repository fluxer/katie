...
class Q_CORE_EXPORT QAbstractSocket : public QIODevice
{
    Q_OBJECT
...
#ifndef QT_NO_DEBUG_STREAM
Q_CORE_EXPORT QDebug operator<<(QDebug, QAbstractSocket::SocketError);
Q_CORE_EXPORT QDebug operator<<(QDebug, QAbstractSocket::SocketState);
#endif
