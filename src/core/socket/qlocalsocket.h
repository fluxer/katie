...
class Q_CORE_EXPORT QLocalSocket : public QIODevice
{
    Q_OBJECT
...
Q_CORE_EXPORT QDebug operator<<(QDebug, QLocalSocket::LocalSocketError);
Q_CORE_EXPORT QDebug operator<<(QDebug, QLocalSocket::LocalSocketState);
#endif
