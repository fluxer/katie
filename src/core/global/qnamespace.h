...
public:
    ...
    enum WidgetAttribute {
        ...
        WA_LaidOut = 66,
        WA_PendingUpdate = 67,
        WA_GrabbedShortcut = 68,
        WA_DontShowOnScreen = 69,
        WA_ForceUpdatesDisabled = 70,
        WA_StyledBackground = 71,
        WA_StyleSheet = 72,
        WA_DropSiteRegistered = 73,
        WA_WState_Visible = 74,
        WA_WState_Hidden = 75,
        WA_WState_Created = 76,
        WA_WState_InPaintEvent = 77,
        WA_WState_Reparented = 78,
        WA_WState_Polished = 79,
        WA_WState_OwnSizePolicy = 80,
        WA_WState_ExplicitShowHide = 81,
        WA_WState_ConfigPending = 82,
        WA_WState_AcceptedTouchBeginEvent = 83,
        WA_SetWindowIcon = 84,
        WA_SetLayoutDirection = 85,
        WA_SetWindowModality = 86,
        WA_NoX11EventCompression = 87,
