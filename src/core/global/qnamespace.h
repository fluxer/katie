...
public:
    ...
    enum WidgetAttribute {
        ...
        WA_PaintUnclipped = 22,
        WA_NoMouseReplay = 23,
        WA_DeleteOnClose = 24,
        WA_RightToLeft = 25,
        WA_NoChildEventsForParent = 26,
        WA_ShowModal = 27, // ## deprecated
        WA_MouseNoMask = 28,
        WA_GroupLeader = 29, // ## deprecated
        WA_NoMousePropagation = 30, // ## for now, might go away.
        WA_Hover = 31,
        WA_QuitOnClose = 32,
        WA_KeyboardFocusChange = 33,
        WA_AcceptDrops = 34,
        WA_WindowPropagation = 35,
        WA_AlwaysShowToolTips = 36,
        WA_SetStyle = 37,
        WA_SetLocale = 38,
        WA_LayoutUsesWidgetRect = 39,
        WA_ShowWithoutActivating = 40,
        WA_NativeWindow = 41,
        WA_DontCreateNativeAncestors = 42,
        WA_TranslucentBackground = 43,
        WA_X11DoNotAcceptFocus = 44,
        WA_X11BypassTransientForHint = 45,

        // window types from http://standards.freedesktop.org/wm-spec/
        WA_X11NetWmWindowTypeDesktop = 46,
        WA_X11NetWmWindowTypeDock = 47,
        WA_X11NetWmWindowTypeToolBar = 48,
        WA_X11NetWmWindowTypeMenu = 49,
        WA_X11NetWmWindowTypeUtility = 50,
        WA_X11NetWmWindowTypeSplash = 51,
        WA_X11NetWmWindowTypeDialog = 52,
        WA_X11NetWmWindowTypeDropDownMenu = 53,
        WA_X11NetWmWindowTypePopupMenu = 54,
        WA_X11NetWmWindowTypeToolTip = 55,
        WA_X11NetWmWindowTypeNotification = 56,
        WA_X11NetWmWindowTypeCombo = 57,
        WA_X11NetWmWindowTypeDND = 58,

        // internal
        WA_LaidOut = 59,
        WA_GrabbedShortcut = 60,
        WA_DontShowOnScreen = 61,
        WA_ForceUpdatesDisabled = 62,
        WA_StyledBackground = 63,
        WA_StyleSheet = 64,
        WA_DropSiteRegistered = 65,
        WA_WState_Visible = 66,
        WA_WState_Hidden = 67,
        WA_WState_Created = 68,
        WA_WState_InPaintEvent = 69,
        WA_WState_Reparented = 70,
        WA_WState_Polished = 71,
        WA_WState_OwnSizePolicy = 72,
        WA_WState_ExplicitShowHide = 73,
        WA_WState_ConfigPending = 74,
        WA_SetWindowIcon = 75,
        WA_SetLayoutDirection = 76,
        WA_SetWindowModality = 77,
        WA_NoX11EventCompression = 78,
