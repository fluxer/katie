...
void QXmlStreamReaderPrivate::resolveTag()
{
    ...
    for (int a = 0; a < dtdAttributes.size(); ++a) {
        ...
        attribute.m_name = QStringRef(dtdAttribute.attributeName);
        attribute.m_qualifiedName = QStringRef(dtdAttribute.attributeQualifiedName);
        attribute.m_value = QStringRef(dtdAttribute.defaultValue);
...
void QXmlStreamReaderPrivate::resolvePublicNamespaces()
{
    ...
    for (int i = 0; i < n; ++i) {
        ...
        publicNamespaceDeclaration.m_prefix = QStringRef(namespaceDeclaration.prefix);
        publicNamespaceDeclaration.m_namespaceUri = QStringRef(namespaceDeclaration.namespaceUri);
    }
}
...
void QXmlStreamReaderPrivate::resolveDtd()
{
    ...
    for (int i = 0; i < notationDeclarations.size(); ++i) {
        ...
        publicNotationDeclaration.m_name = QStringRef(notationDeclaration.name);
        publicNotationDeclaration.m_systemId = QStringRef(notationDeclaration.systemId);
        publicNotationDeclaration.m_publicId = QStringRef(notationDeclaration.publicId);
    ...
    for (int i = 0; i < entityDeclarations.size(); ++i) {
        ...
        publicEntityDeclaration.m_name = QStringRef(entityDeclaration.name);
        publicEntityDeclaration.m_notationName = QStringRef(entityDeclaration.notationName);
        publicEntityDeclaration.m_systemId = QStringRef(entityDeclaration.systemId);
        publicEntityDeclaration.m_publicId = QStringRef(entityDeclaration.publicId);
        publicEntityDeclaration.m_value = QStringRef(entityDeclaration.value);
    }
