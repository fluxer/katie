...
/*!
    ...
    If \a encodingPolicy is EncodingFromTextStream the encoding specified in
    the text stream \a str is used.
...
/*!
    ...
    If \a importedNode is a \link QDomNode::isNull() null node\endlink,
