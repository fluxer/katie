...
/*!
    ...
    Joins the the multicast group specified by \a groupAddress on the interface \a
    iface. iface defaults to interface chosen by the operating system. The socket
    must be in BoundState, otherwise an error occurs.
