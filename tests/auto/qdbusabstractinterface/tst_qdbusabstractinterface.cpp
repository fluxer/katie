...
void tst_QDBusAbstractInterface::createErrors_data()
{
    ...
    QTest::newRow("invalid-service") << "this isn't valid" << "/" << "Katie.QtDBus.Error.InvalidService";
...
void tst_QDBusAbstractInterface::createErrorsPeer_data()
{
    ...
    QTest::newRow("invalid-path") << "this isn't valid" << "Katie.QtDBus.Error.InvalidObjectPath";
}
...
{
    createErrors_data();
    QTest::newRow("service-wildcard") << QString() << "/" << "Katie.QtDBus.Error.InvalidService";
    QTest::newRow("path-wildcard") << QDBusConnection::sessionBus().baseService() << QString()
            << "Katie.QtDBus.Error.InvalidObjectPath";
    QTest::newRow("full-wildcard") << QString() << QString() << "Katie.QtDBus.Error.InvalidService";
}
...
void tst_QDBusAbstractInterface::callErrorsPeer_data()
{
    ...
    QTest::newRow("path-wildcard") << QString() << "Katie.QtDBus.Error.InvalidObjectPath";
}
...
#include "moc_tst_qdbusabstractinterface.cpp"
