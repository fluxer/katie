...
{
    Menu258920 menu;
    // In case styleHint(QStyle::SH_Menu_MouseTracking) is set to false.
    // For all styles which inherit from QWindowsStyle, the value is true.
