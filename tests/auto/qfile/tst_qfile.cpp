...
//    QTest::newRow("data2") << "tst_qfile.cpp" << int(QFile::WriteUser) << false;
    QTest::newRow("data3") << SRCDIR "testdata/file1.ext1" << uint(QFile::ReadUser) << true;
    QTest::newRow("data4") << SRCDIR "testdata/file1.ext1" << uint(QFile::WriteUser) << true;
    QTest::newRow("data5") << SRCDIR "testdatas/file1.ext1" << uint(QFile::ExeUser) << false;
}
