...
void tst_QByteArray::indexOf_data()
{
    ...
    // task 203692
    static const char h19[] = { 'x', 0x00, static_cast<char>(0xe7), 0x25, 0x1c, 0x0a };
...
void tst_QByteArray::lastIndexOf_data()
{
    ...
    // task 203692
    static const char h25[] = { 0x00, static_cast<char>(0xbc), 0x03, 0x10, 0x0a };
...
#include "moc_tst_qbytearray.cpp"
