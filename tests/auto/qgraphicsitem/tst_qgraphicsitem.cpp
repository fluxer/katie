...
void tst_QGraphicsItem::update()
{
    ...
    QCOMPARE(item->repaints, 1);
    QCOMPARE(view.repaints, 1);
    QTRY_COMPARE(view.paintedRegion, expectedRegion + expectedRegion.translated(50, 50));
...
#define RESET_COUNTERS \
    ...
    QTRY_COMPARE(view.paintedRegion, expectedParentRegion);
    ...
    QTRY_COMPARE(view.paintedRegion, expectedChildRegion);
    ...
    QTRY_COMPARE(view.paintedRegion, expectedGrandChildRegion);
