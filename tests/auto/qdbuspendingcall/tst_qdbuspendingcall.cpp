...
#define TEST_INTERFACE_NAME "Katie.QtDBus.MyObject"

class MyObject : public QDBusAbstractAdaptor
{
    Q_OBJECT
    Q_CLASSINFO("D-Bus Interface", "Katie.QtDBus.MyObject")
...
public slots:
    ...
    {
        QDBusMessage copy(msg);
        copy.setDelayedReply(true);
        QDBusConnection::sessionBus().send(copy.createErrorReply("dbuspendingcall_error", ""));
    }
};
...
#include "moc_tst_qdbuspendingcall.cpp"
