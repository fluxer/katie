...
void tst_QPainter::blendOverFlow_data()
{
    ...
    QTest::newRow("argb32p,1,1") << format << 1 << 1;
    QTest::newRow("argb32p,2,2") << format << 2 << 2;
    QTest::newRow("argb32p,10,10") << format << 10 << 10;

    format = QImage::Format_ARGB32;
    QTest::newRow("argb32,1,1") << format << 1 << 1;
    QTest::newRow("argb32,2,2") << format << 2 << 2;
    QTest::newRow("argb32,10,10") << format << 10 << 10;
}
...
void tst_QPainter::imageBlending_data()
{
    ...
    QTest::newRow("rgb16_on_rgb16") << QImage::Format_RGB16
                                      << QImage::Format_RGB16
                                      << 0;

    QTest::newRow("rgb32_on_rgb16") << QImage::Format_RGB32
                                     << QImage::Format_RGB16
                                     << error_rgb565;

    QTest::newRow("argb32pm_on_rgb16") << QImage::Format_ARGB32_Premultiplied
                                        << QImage::Format_RGB16
                                        << error_rgb565;
}
